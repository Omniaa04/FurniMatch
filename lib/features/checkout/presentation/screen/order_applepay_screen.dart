...
class OrderApplePayScreen extends StatelessWidget {
  const OrderApplePayScreen({super.key});
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () {
                  // Navigate to Apple Pay processing screen
                  Navigator.pushNamed(context, "/processing_applepay");
                },
                style: ElevatedButton.styleFrom(
                  backgroundColor: const Color(0xFF7D533D),
                  shape: RoundedRectangleBorder(
