...
// import 'package:furnimatch/features/location/presentation/screen/select_location_screen.dart';
...
//   image: "assets/images/cod_truck.png",
//   onTap: () {
//     Navigator.push(
//       context,
//       MaterialPageRoute(
//         builder: (_) => SelectLocationScreen(userId: widget.userId),
//       ),
//     );
//   },
// ),
        ...
        child: Column(
          ...
          children: [
            ...
            PaymentOptionTile(
              title: "Apple Pay",
              image: "assets/images/apple_pay.png",
              onTap: () => Navigator.pushNamed(context, "/apple_pay"),
            ),
            const SizedBox(height: 25),
            const Text(
              "Other Options",
