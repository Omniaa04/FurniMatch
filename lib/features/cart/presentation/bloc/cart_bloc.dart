...
class CartBloc extends Bloc<CartEvent, CartState> {
  ...
  Future<void> _onLoadCart(
    ...
    print("LOAD CART EVENT");

    // ✅ شيلنا الـ guard اللي كان بيعمل return لو state is CartLoading
    // عشان كان بيمنع الـ reload لما المستخدم يفتح الـ cart بعد ما يضيف products
