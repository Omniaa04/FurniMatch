...
//  import existing 3D screen 
import '/features/RoomMeasurement/presentation/screen/room_3d_screen.dart';
import 'package:furnimatch/features/RoomMeasurement/presentation/screen/room_name_screen.dart';
...
class _MeasurementScreenState extends State<MeasurementScreen> {
      ...
      child: Scaffold(
        ...
        body: BlocConsumer<MeasurementBloc, MeasurementState>(
          listener: (context, state) {
            ...
            // Auto-show save dialog when done
            if (state is MeasurementSuccess) {
              void showSaveDialog(BuildContext context, RoomDimensions dimensions) {
  Navigator.of(context).push(MaterialPageRoute(
    builder: (_) => RoomNameScreen(dimensions: dimensions),
  ));
}
            }
          },
          builder: (context, state) {
            return Stack(
              children: [
                ...
                AROverlayWidget(
                  dimensions:
                      state is MeasurementSuccess ? state.dimensions : null,
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                      color: AppColors.lighter.withValues(alpha: 0.4)),
                ),
                child: const Row(
                  children: [
                    Icon(Icons.straighten,
                        color: AppColors.lighter, size: 16),
                    SizedBox(width: 6),
  ...
  Widget _buildBottomControls(
      BuildContext context, MeasurementState state) {
            ...
            if (!hasResult && !isLoading)
              Container(
                ...
                child: const Text(
                  ...
                  style:
                      TextStyle(color: AppColors.lightest, fontSize: 12),
                ),
              ),
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                    color: AppColors.lighter.withValues(alpha: 0.35)),
              ),
              child: Column(
                mainAxisSize: MainAxisSize.min,
                children: [
                      ...
                      children: [
                        Expanded(
                          child: _OutlineBtn(
                            ...
                            onTap: () {
                              _navigated = false;
                              _bloc.add(const ResetMeasurementEvent());
                            },
                          ),
                        ),
          ...
          child: Column(
            ...
            children: [
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: Icon(Icons.close,
                        color: AppColors.medium.withValues(alpha: 0.7),
                        size: 20),
                  ),
                ],
              ),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: AppColors.lightest.withValues(alpha: 0.5),
                ...
                child: Row(
                  ...
                  children: [
                    _InfoChip(
                        label: 'Length',
                        value:
                            '${dimensions.length.toStringAsFixed(2)}m'),
                    _InfoChip(
                        label: 'Width',
                        value:
                            '${dimensions.width.toStringAsFixed(2)}m'),
                    _InfoChip(
                        label: 'Height',
                        value:
                            '${dimensions.height.toStringAsFixed(2)}m'),
                    _InfoChip(
                        label: 'Area',
                        value:
                            '${dimensions.area.toStringAsFixed(1)}m²'),
                  ],
                ),
              ),
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  hintStyle: TextStyle(
                      color: AppColors.medium.withValues(alpha: 0.55),
                      fontSize: 14),
                  prefixIcon: const Icon(Icons.meeting_room_outlined,
                      color: AppColors.primary, size: 20),
                  filled: true,
                  fillColor: AppColors.lightest.withValues(alpha: 0.4),
                  ...
                  enabledBorder: OutlineInputBorder(
                    ...
                    borderSide: const BorderSide(
                        color: AppColors.lighter, width: 1),
                  ),
                ...
                children: [
                  Expanded(
                    child: OutlinedButton(
                      // Skip saving → go straight to 3D
                      onPressed: () {
                        Navigator.pop(dialogContext);
                        _goTo3DRoom(dimensions);
                      },
                      style: OutlinedButton.styleFrom(
                        foregroundColor: AppColors.medium,
                        side:
                            const BorderSide(color: AppColors.lighter),
                        shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(12)),
                        padding:
                  ...
                  Expanded(
                    child: ElevatedButton(
                      onPressed: () {
                        ...
                        if (name.isNotEmpty) {
                          SavedRoomsStore.save(SavedRoom(
                    ...
                    return ListView.separated(
                      ...
                      itemBuilder: (_, i) => _SavedRoomTile(
                        ...
                        onOpen: () {
                          ...
                          _goTo3DRoom(rooms[i].dimensions);
                        },
                        onDelete: () {
          ...
          child: Row(
            ...
            children: [
              _SmallStat(
                  label: 'Floor Area',
                  value:
                      '${dimensions.area.toStringAsFixed(2)} m²'),
              Container(
                  width: 1,
                  height: 24,
                  color: AppColors.lighter.withValues(alpha: 0.4)),
              _SmallStat(
                  label: 'Volume',
                  value:
                      '${dimensions.volume.toStringAsFixed(2)} m³'),
            ],
          ),
        ),
      ],
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        Text(label,
            style: const TextStyle(
                color: AppColors.lighter, fontSize: 11)),
        const SizedBox(height: 2),
        Text(value,
            style: const TextStyle(
                color: AppColors.lightest,
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          border: Border.all(
              color: AppColors.lighter.withValues(alpha: 0.5)),
          borderRadius: BorderRadius.circular(12),
        ),
        child: Row(
          mainAxisAlignment: MainAxisAlignment.center,
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
              color: AppColors.lighter.withValues(alpha: 0.15),
              blurRadius: 8,
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 4),
                Text(
                  '${d.length.toStringAsFixed(2)}m × ${d.width.toStringAsFixed(2)}m × ${d.height.toStringAsFixed(2)}m',
                  style: const TextStyle(
