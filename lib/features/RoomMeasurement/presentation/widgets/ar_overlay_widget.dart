            ...
            child: Center(
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: const Color(0xFF7D533D).withValues(alpha: 0.75),
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: CircularProgressIndicator(
                          strokeWidth: 1.5, color: Color(0xFFF5D1A9)),
                    ),
                    SizedBox(width: 8),
                    Text('Analysing room...',
                        style:
                            TextStyle(color: Color(0xFFF5D1A9), fontSize: 13)),
                  ],
                ),
              ),
            ),
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final paint = Paint()
      ..shader = LinearGradient(
        colors: [
          Colors.transparent,
          const Color(0xFFCF8D5B).withValues(alpha: 0.7),
          Colors.transparent,
        ],
